...
public class MyUtil {
    ...
    /**
     * Add margin to rect
     * Use the same length and increase the width to be the same as the length
     * @param bitmap
     * @param rect
     */
    ...
    /**
     * Image matrix width and height transposition
     * @param in
     * @return
     */
    ...
    /**
     * 4D image batch matrix width and height transposition
     * @param in
     * @return
     */
    ...
    /**
     * Intercept the rectangular frame specified in the box (out of bounds needs to be processed), resize to size*size, and return the data and store it in data.
     * @param bitmap
     * @param box
     * @param size
     * return
    ...
    /**
     * Crop the face according to the size of the rect
     * @param bitmap
     * @param rect
     * @return
     */
