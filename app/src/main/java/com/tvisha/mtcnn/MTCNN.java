...
public class MTCNN {
    ...
    /**
     * Execute Regression after NMS is executed
     * (1) For each scale , use NMS with threshold=0.5
     * (2) For all candidates , use NMS with threshold=0.7
     * (3) Calibrate Bounding Box
     * Note: CNN input the top row of the image, the coordinates are [0..width,0]. So Bitmap needs to be folded in half before running the network; the network output is the same.
     *
     * @param bitmap
     * @return
     */
    ...
    /**
     * nms, unqualified deleted set to true
     *
     * @param boxes
     * @param threshold
     * @param method
    ...
    /**
     * RNET runs neural network, writes score and bias into boxes
     *
     * @param rNetIn
     * @param boxes
     */
    ...
    /**
     * ONet runs neural network, writes score and bias into boxes
     *
     * @param oNetIn
     * @param boxes
     */
